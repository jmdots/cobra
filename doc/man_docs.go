...
// current time if Date is unset and will use "Auto generated by kubeteam/cobra"
...
func fillHeader(header *GenManHeader, name string) error {
	...
	if header.Source == "" {
		header.Source = "Auto generated by kubeteam/cobra"
	}
	return nil
}
...
func genMan(cmd *cobra.Command, header *GenManHeader) []byte {
	...
	if !cmd.DisableAutoGenTag {
		buf.WriteString(fmt.Sprintf("# HISTORY\n%s Auto generated by kubeteam/cobra\n", header.Date.Format("2-Jan-2006")))
	}
	return buf.Bytes()
}
